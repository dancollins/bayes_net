...
{ { true, false }, { true, false }, { true, true }, 
  ...
  { false, true } };
	...
	public static void main(String[] ops) {
		...
		// Print out results of some example queries based on MCMC
		System.out.println("\nLikelihood Weighting");

		// Probability of rain given wet grass and NOT playing outside.
		System.out.print("P(rain | wet grass, ~playing outside) = ");
		System.out.println(b.likelihoodWeighting(3, new int[] { 4, 5 },
												 new boolean[] { false, true }, 10000));
		
		// Probability of sprinklers given a drought
		System.out.print("P(sprinklers | drought) = ");
		System.out.println(b.likelihoodWeighting(2, new int[] { 1 },
												 new boolean[] { true }, 100000));
		
		// Probability of wet grass given rain and sprinklers
		System.out.print("P(wet grass | rain, sprinklers) = ");
		System.out.println(b.likelihoodWeighting(5, new int[] { 2, 3 },
												 new boolean[] { true, true }, 10000000));

		// Print out results of some example queries based on likelihood
		// weighting
		System.out.println("\nMCMC");

		// Probability of rain given wet grass and NOT playing outside.
		System.out.print("P(rain | wet grass, ~playing outside) = ");
		System.out.println(b.MCMCask(3, new int[] { 4, 5 },
									 new boolean[] { false, true }, 10000));
		
		// Probability of sprinklers given a drought
		System.out.print("P(sprinklers | drought) = ");
		System.out.println(b.MCMCask(2, new int[] { 1 },
									 new boolean[] { true }, 100000));
		
		// Probability of wet grass given rain and sprinklers
		System.out.print("P(wet grass | rain, sprinklers) = ");
		System.out.println(b.MCMCask(5, new int[] { 2, 3 },
									 new boolean[] { true, true }, 10000000));
	}
}
